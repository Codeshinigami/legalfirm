                    ...
                    <ul className="flex flex-col py-4 space-y-1">
                        {navLinks.map((link, i) => {
                            return (link.title ? 
                                ...
                                <li key={i}>
                                    <a href={link.navigateto} className={`relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50  hover:text-gray-800 border-l-4 border-transparent hover:border-indigo-500 pr-6 ${currentPath == link.navigateto && "bg-gray-0 text-gray-800 border-l-4 !border-indigo-500 pr-6"}`}>
