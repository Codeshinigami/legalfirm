    ...
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-[#ffffff] `}>
      ...
      <div className=" w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        <ul className='list-none hidden items-center sm:flex flex-row gap-10'>
          ...
          <li className='text-[18px] font-medium cursor-pointer'><button className=" list-none text-violet-600 text-center text-[18px] shadow-lg border-violet-600 border bg-white self-center justify-center px-8 py-1 rounded-[40px] max-md:px-5" onClick={() => setLogin(!login)}>Login</button></li>
