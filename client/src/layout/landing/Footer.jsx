                ...
                <div
                    ...
                    <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                        <a class="flex items-center justify-center font-medium text-gray-900 title-font md:justify-start">
                            <img src={swoc} alt="" className="w-11 h-10"/>
                            <p className="flex flex-col pl-1 font-semibold">LegalFirm <span class="font-normal text-sm text-gray-500">Get law advice!</span></p>
                        </a>
                        <div class="mt-4">
