...
export default function Ip() {
  ...
  <div class="form">
    ...
    <input id="effectiveDate" type="date" class="form-input mb-4 border-b-2 border-purple-500 px-3 py-1 rounded-md" />
    ...
    <input id="employeeAddress" type="text" placeholder="Employee Address" class="form-input mb-4 border-b-2 border-purple-500 px-3 py-1 rounded-md mx-2" />
    ...
    <input id="employerAddress" type="text" placeholder="Employer Address" class="form-input mb-4 border-b-2 border-purple-500 px-3 py-1 rounded-md mx-2" />
    <h4 class="text-lg font-bold mb-2">RECOGNITION OF PRE-EXISTING PROPERTY</h4>
    <input id="property-1" type="text" placeholder="Property-1" class="form-input mb-2 border-b-2 border-purple-500 px-3 py-1 rounded-md" />
    <input id="property-2" type="text" placeholder="Property-2" class="form-input mb-4 border-b-2 border-purple-500 px-3 py-1 rounded-md mx-2" />
    <h4 class="text-lg font-bold mb-2">TERM OF AGREEMENT</h4>
    <label class="block mb-2">This Agreement commences on</label>
    <input id="commence-date" type="date" class="form-input mb-2 border-b-2 border-purple-500 px-3 py-1 rounded-md" />
    <label class="block mb-2">This Agreement terminates on</label>
    <input id="terminate-date" type="date" class="form-input mb-2 border-b-2 border-purple-500 px-3 py-1 rounded-md" />
    <input id="legal-framework" type="number" placeholder="Legal Framework" class="form-input mb-4 border-b-2 border-purple-500 px-3 py-1 rounded-md mx-2" />
  </div>
  <div>
