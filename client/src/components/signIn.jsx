                ...
                <div className="w-full bg-white rounded-2xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
                    <div className="p-8 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            ...
                            <div class="bg-white mr-auto ml-auto border-2 border-solid  text-gray-100 hover:text-white shadow font-bold text-sm py-2 px-4 flex justify-center items-center cursor-pointer w-[60%] rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="w-6 h-6 mr-2" viewBox="0 0 48 48">
                            ...
                            <button type="submit" className="w-full text-white bg-blue-600 hover:bg-primary-700 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Sign in</button>
                            <p className="text-sm font-light text-center text-black">
                                Don't have an account yet? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500"><span>Signup</span></a>
                            </p>
                        </form>
                    </div>
                </div>
