                ...
                <div className="w-full bg-white rounded-2xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
                    <div className="p-8 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" action="#">
                            ...
                            <p className="text-sm font-light text-center text-black"> Do not have an account yet? <a href="#" className="font-medium text-primary-600 hover:underline dark:text-primary-500"><span>Signup</span></a>
                            </p>
                        </form>
                    </div>
                </div>
