                    ...
                    <div className="w-full bg-white rounded-2xl shadow dark:border md:mt-0 sm:max-w-md xl:p-0 z-30">
                        <div className="p-8 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-6">
                                ...
                                <button type="submit" className="w-full text-white bg-blue-600 hover:bg-primary-700 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Sign {signup ? "up" : "in"}</button>
                                <p className="text-sm font-light text-center text-black"> {signup ? "Already have an account?" : "Do not have an account yet?"} <a href="#" onClick={() => {setSignup(!signup)}} className="font-medium text-primary-600 hover:underline dark:text-primary-500"><span>Sign{signup ? "in" : "up"}</span></a>
                                </p>
                            </form>
                        </div>
                    </div>
