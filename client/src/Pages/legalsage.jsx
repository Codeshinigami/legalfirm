        ...
        <div className="h-[90vh] flex flex-col relative">
            ...
            <div className="h-[12%] grid items-center bg-transparent backdrop-blur-lg">
                <div className="relative flex justify-center items-center">
                    <input type="text" ref={chatInput} onChange={(e) => { setMessage(e.target.value) }} placeholder="Ask LegalSage to get your Legal Queries Answered........" onKeyDown={handleEnterKey} className="w-[70%] prevent-select ml-auto mr-auto p-5 pr-14 h-[50px] leading-3 bg-gray-200 border-0 rounded-full focus:outline-none" />
